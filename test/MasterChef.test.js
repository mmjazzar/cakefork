...
contract('MasterChef', ([alice, bob, carol, dev, minter]) => {
    ...
    it('deposit/withdraw', async () => {
      ...
      const before_balance = (await this.lp1.balanceOf(dev)).toString();
      console.log('before_balance', before_balance);
      await this.chef.withdraw(1, '10', { from: alice });
      const after_balanceBNB = (await this.lp1.balanceOf(dev)).toString();
      console.log('after_balanceBNB', after_balanceBNB);
